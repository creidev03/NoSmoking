      ...
      <div className="flex flex-wrap justify-center gap-3">
        {MOTIVATIONS.map((motivation) => (
          <Button
            ...
            variant="outline"
            disabled={disabled}
            className="h-12 rounded-lg border-gray-200 bg-white/80 px-4 text-base backdrop-blur transition-all hover:bg-emerald-50 hover:text-emerald-700 active:scale-95"
